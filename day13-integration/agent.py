...
from tools import get_weather, web_search,extract_info # 从工具模块导入工具函数
...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function":{
            "name":"extract_info",
            "description":"从一段文本中抽取结构化信息（姓名、电话、地址等）",
            "parameters":{
                "type":"object",
                "properties":{
...
if __name__ == "__main__":
    print(extract_info("张三，男，电话 13800138000，地址 北京市朝阳区", ["姓名","性别","电话","地址"])) # 测试 extract_info 工具，从一段文本中抽取姓名、性别、电话和地址等信息
